...
const ChatView: React.FC<ChatViewProps> = ({ memories, googleConfig, messages, setMessages, bankData = [] }) => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const systemInstruction = `Eres el "Consultor Cognitivo" de Pablo Carcelén. Profesional e impecable. Responde basándote en su historial de memorias y finanzas. Sé directo y útil.`;
      ...
      const errorText = err.message === "API_KEY_MISSING" 
        ? "Pablo, no detecto una clave de IA activa. Ve a Ajustes y pulsa 'Gestionar Clave de Google AI'."
        : "Lo siento Pablo, error al consultar con Gemini. Revisa la consola.";
